...
export function CoverflowCarousel({
  ...
  showPagination = true,
  showNavigation = true,
  label = "Regional aachar carousel",
  className,
  cardClassName,
  onSelectSlide,
  ...
  return (
    ...
    >
          ...
          >
            {slides.map((slide, index) => (
              <div
                ...
                className={cn(
                  "absolute left-1/2 top-0 aspect-[3/4] overflow-hidden rounded-3xl bg-muted shadow-xl will-change-transform",
                  cardClassName,
                )}
      ...
      {showCaption && active?.title && (
        ...
        >
          <p className="font-heading text-xl font-semibold tracking-tight text-kissan-green-deep">
            {active.title}
          </p>
          {active.subtitle && (
        ...
        <div className="mt-5 flex items-center justify-center gap-2">
          {slides.map((_, index) => (
            <button
              ...
              onClick={() => goTo(index)}
              className={cn(
                "size-2 rounded-full bg-kissan-green transition-opacity",

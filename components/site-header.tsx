  ...
  return (
    <header className="absolute inset-x-0 top-0 z-30 flex items-center justify-between px-6 py-6 sm:px-10">
      <Link href="/" className="flex items-center gap-2 text-kissan-cream">
        <span className="glass-red flex items-center gap-1.5 rounded-2xl px-3 py-1.5 font-heading text-lg font-semibold italic tracking-tight text-white">
          kissan
        </span>
      ...
      <nav className="flex items-center gap-6 text-sm font-medium text-kissan-cream/90">
        ...
        <span className="glass-pill-dark inline-flex items-center gap-1.5 rounded-full px-3 py-1.5 text-xs text-kissan-cream">
